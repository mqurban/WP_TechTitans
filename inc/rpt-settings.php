...
if ( isset( $_POST[ 'action' ] ) && ( $_POST[ 'action' ] == 'update' ) ) {
    ...
    if ( $validation ) {
		...
		if ( isset( $_POST['relpoststh_disable_images'] ) ) {
			update_option( 'relpoststh_disable_images', intval( $_POST['relpoststh_disable_images'] ) );
		} else {
			update_option( 'relpoststh_disable_images', 0 );
		}
    ...
    <div class="wpbr-wrap"><div class="wpbr-tabsWrapper">
		<div id="relpoststh-settings" class="">
			...
			<div class="postbox"  id="content_general_options">
				...
				<tr>
					<th scope="row">
						<?php _e( 'Disable Related Post Thumbnails', 'related-posts-thumbnails' ); ?>:
					</th>
					<td>
						<input type="checkbox" name="relpoststh_disable_images" id="relpoststh_disable_images" value="1"
							<?php
							...
							?>
						/>
						<label for="relpoststh_disable_images">
							<?php _e( 'Disable related post thumbnails and view as a list', 'related-posts-thumbnails' ); ?>
						</label>
					</td>
				</tr>
